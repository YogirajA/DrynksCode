...
-- ==========================================================
if exists (select 1 from dbo.sysobjects where id = object_id(N'[dbo].[SpGetDrinksByType]') 
		and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	Drop procedure SpGetDrinksByType
End
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE SpGetDrinksByType 
...
BEGIN
	...
	With seq as
	(
	    select T.TagName, D.*, ROW_NUMBER() OVER (ORDER BY D.ID ASC) RowNumber
										,Count(*) OVER () Total 
		from Drink D
